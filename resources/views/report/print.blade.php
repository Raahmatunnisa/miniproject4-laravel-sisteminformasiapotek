...
<head>
    ...
    {{-- Title --}}
    <title>Transaksi' Laporan Data pada {{ date('F j, Y', strtotime(request('start_date'))) }} - {{ date('F j, Y', strtotime(request('end_date'))) }}</title>
...
<body>
    ...
    <div style="text-align: center">
        <h3>Transaksi' Laporan Data pada {{ date('F j, Y', strtotime(request('start_date'))) }} - {{ date('F j, Y', strtotime(request('end_date'))) }}.</h3>
    </div>
    ...
    <div style="margin-top: 25px; text-align: right">Banda Aceh, {{ date('F j, Y') }}</div>
</body>
